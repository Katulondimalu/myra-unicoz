      ...
      >
        ...
        >
          ...
          <Typography variant="p" fontSize={18} fontWeight={300}>
            ...
            konden meedoen met de nieuwe Monitor Digitalisering Funderend
            Onderwijs MYRA.
            <br />
            Na de eerste aanmeldingen zijn we nu in staat om de resultaten
            binnen twee tot drie weken met u te delen. Via deze portal kunt u
            inloggen met uw Unicoz gegevens, zodat de voor u relevante data als
            PDF wordt opgestuurd zodra deze gereed is.
            <br />
            MYRA is een gezamenlijk initiatief van Kennisnet, de PO-Raad en de
            VO-raad. MYRA geeft eenvoudig en volledig inzicht in de stand van
            digitalisering op scholen én de gehele sector.
          </Typography>
        </Stack>
        <Stack
          sx={{
